...
public class PageMaker {
    ...
    private void makePageInfo(){
        ...
        // 3. prev 활성화 여부
        /*
                1 ~ 10 구간에는 prev가 안보여도됨
                11 ~ 20 구간에는 1 ~10 구간으로 이동가능하므로 prev를 활성화
                41 ~ 50 구간에도 31 ~ 40 구간으로 이동가능하므로 활성화
         */
        this.prev = begin > 1;
        ...
        /*
              ...
              21 ~ 30페이지구간 : 게시물 총 37개 -> 끝 페이지가 과연 30이 맞는가? 24페이지
              => 30을 24로 보정해야 함
        ...
        // 마지막 페이지 구간에서는 end값을 finalPage값으로 변경
